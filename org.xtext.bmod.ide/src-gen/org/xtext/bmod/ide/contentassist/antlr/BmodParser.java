...
public class BmodParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BmodGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRoomAccess().getNamedAssignment_2_1(), "rule__Room__NamedAssignment_2_1");
			...
			builder.put(grammarAccess.getPerceptionLevelAccess().getPersonAssignment_3(), "rule__PerceptionLevel__PersonAssignment_3");
			builder.put(grammarAccess.getPerceptionLevelAccess().getObjectsAssignment_5(), "rule__PerceptionLevel__ObjectsAssignment_5");
			builder.put(grammarAccess.getPerceptionLevelAccess().getBodyAssignment_7(), "rule__PerceptionLevel__BodyAssignment_7");
			builder.put(grammarAccess.getActionProfileAccess().getNameAssignment_1(), "rule__ActionProfile__NameAssignment_1");
			builder.put(grammarAccess.getActionProfileAccess().getPersonAssignment_3(), "rule__ActionProfile__PersonAssignment_3");
			builder.put(grammarAccess.getActionProfileAccess().getObjectsAssignment_5(), "rule__ActionProfile__ObjectsAssignment_5");
			builder.put(grammarAccess.getActionProfileAccess().getBodyAssignment_7(), "rule__ActionProfile__BodyAssignment_7");
			...
			builder.put(grammarAccess.getPersonAccess().getPerceptionAssignment_7(), "rule__Person__PerceptionAssignment_7");
			builder.put(grammarAccess.getPersonAccess().getActionAssignment_9(), "rule__Person__ActionAssignment_9");
