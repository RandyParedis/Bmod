...
public class BmodParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BmodGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFloorplanAccess().getSignsAssignment_1_6(), "rule__Floorplan__SignsAssignment_1_6");
			builder.put(grammarAccess.getFloorplanAccess().getDanconsAssignment_1_7(), "rule__Floorplan__DanconsAssignment_1_7");
