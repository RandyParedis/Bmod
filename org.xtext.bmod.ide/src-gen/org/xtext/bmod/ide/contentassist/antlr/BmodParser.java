...
public class BmodParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BmodGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPersonAccess().getAlternatives_7(), "rule__Person__Alternatives_7");
			...
			builder.put(grammarAccess.getRoomAccess().getGroup_5(), "rule__Room__Group_5__0");
			...
			builder.put(grammarAccess.getPersonAccess().getGroup_7_0(), "rule__Person__Group_7_0__0");
			builder.put(grammarAccess.getPersonAccess().getGroup_7_1(), "rule__Person__Group_7_1__0");
			...
			builder.put(grammarAccess.getFloorplanAccess().getExitsAssignment_1_3(), "rule__Floorplan__ExitsAssignment_1_3");
			builder.put(grammarAccess.getFloorplanAccess().getSignsAssignment_1_4(), "rule__Floorplan__SignsAssignment_1_4");
			builder.put(grammarAccess.getFloorplanAccess().getDanconsAssignment_1_5(), "rule__Floorplan__DanconsAssignment_1_5");
			...
			builder.put(grammarAccess.getRoomAccess().getAreasAssignment_4(), "rule__Room__AreasAssignment_4");
			builder.put(grammarAccess.getRoomAccess().getAreasAssignment_5_1(), "rule__Room__AreasAssignment_5_1");
			...
			builder.put(grammarAccess.getPersonAccess().getPerceptionAssignment_7_0_0(), "rule__Person__PerceptionAssignment_7_0_0");
			builder.put(grammarAccess.getPersonAccess().getActionAssignment_7_0_2(), "rule__Person__ActionAssignment_7_0_2");
			builder.put(grammarAccess.getPersonAccess().getActionAssignment_7_1_0(), "rule__Person__ActionAssignment_7_1_0");
			builder.put(grammarAccess.getPersonAccess().getPerceptionAssignment_7_1_2(), "rule__Person__PerceptionAssignment_7_1_2");
			...
			builder.put(grammarAccess.getEmergencySignAccess().getToAssignment_4(), "rule__EmergencySign__ToAssignment_4");
