...
define('ace/mode/rules_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/rules/rulesparse'], function(require, exports, module) {

	var oop = require("../lib/oop");
	var Mirror = require("../worker/mirror").Mirror;
	var rulesparse = require("../mode/rules/rulesparse");
	
	importScripts("../parser/antlr-all-min.js");
	importScripts("../parser/RulesLexer.js");
	importScripts("../parser/RulesParser.js");
	...
	(function() {
	    ...
	    this.onUpdate = function() {
		    ...
		    lexer = new RulesLexer(cstream);
		    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
		    parser = new RulesParser(tstream);
		    try {
		    	parser.rule_Model();
		    } catch(err) {
...
define('ace/mode/rules/rulesparse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'rulesparse', function (exports) {
