 ...
 */
(function() {
	rap.registerTypeHandler("org.xtext.ha.web.editor.widget.Rules", {
		factory : function(properties) {
			return new org.xtext.ha.web.editor.widget.Rules(properties);
		},
		destructor : "destroy",
	...
	rwt.qx.Class.define("org.xtext.ha.web.editor.widget.Rules", {
		...
		members : {
			createEditor : function() {
				...
				var workerPath = 'rwt-resources/src-js/org/xtext/ha/web/ace';
				ace.require("ace/config").set("workerPath", workerPath);
				var themePath = 'rwt-resources/src-js/org/xtext/ha/web/ace';
				ace.require("ace/config").set("themePath", themePath);
				var modePath = 'rwt-resources/src-js/org/xtext/ha/web/ace';
				...
				if (editor != null) {
					...
					ace.config.loadModule("ace/ext/language_tools", function (module) {
						editor.getSession().setMode("ace/mode/rules");
						...
						editor.setTheme("ace/theme/rules");
