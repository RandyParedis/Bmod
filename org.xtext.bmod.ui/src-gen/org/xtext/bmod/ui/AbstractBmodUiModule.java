...
import org.xtext.bmod.ui.editor.BmodEditor;
import org.xtext.bmod.ui.labeling.BmodDescriptionLabelProvider;
import org.xtext.bmod.ui.labeling.BmodLabelProvider;
import org.xtext.bmod.ui.outline.BmodOutlineTreeProvider;
import org.xtext.bmod.ui.quickfix.BmodQuickfixProvider;
import org.xtext.bmod.validation.BmodValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link BmodUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractBmodUiModule extends DefaultXbaseUiModule {

	public AbstractBmodUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalBmodLexer.class).toProvider(LexerProvider.create(InternalBmodLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return BmodValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return BmodLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(BmodDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return BmodOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return BmodQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return BmodProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialBmodContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Bmod Compare");
	}
